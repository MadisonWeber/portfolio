  ...
  return (
    <div className="portfolio-card">
      <img
        ...
        src={require("../../photos/adrift-pic.jpg")}
        alt=""
      />
      ...
      <div className="portfolio-link-div">
        <button className="website-link">
          <a
            href="https://adrift-clone.netlify.app/"
            target="_blank"
        ...
        <button className="github-link">
          <a
            href="https://github.com/MadisonWeber/adrift-clone"
            target="_blank"
            rel="noopener noreferrer"
          >
            Github
      ...
      <p className="portfolio-description">
        This was the first website i ever made. Using HTML CSS and Javascript, i
        cloned Adrift Skateboardings landing page.
      </p>
    </div>
  );
};
