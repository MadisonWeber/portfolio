      ...
      <div>
        <div className="skills-container">
          <div className="skills-info">
            <h3>My Skills</h3>
            <p>
              This is an honest evaluation of where my skill level currently is
              across multiple technologies. <br /> I will keep this up to date
              as i continue progressing.
            </p>
          </div>
          <button onClick={addMoveClass} className="show-skills-button">
            See My Skills
          </button>
          <div className="skills-animation-container">
            ...
            <div className="skills-animation">
              <div className="skill javascript">
                <div className="dial javascript" ref={javascriptRef}></div>
              </div>
              <div className="skill react">
                <div className="dial react" ref={reactRef}></div>
              </div>
              <div className="skill css">
                <div className="dial css" ref={cssRef}></div>
              </div>
              <div className="skill html">
                <div className="dial html" ref={htmlRef}></div>
              </div>
              <div className="skill r">
                <div className="dial r" ref={rRef}></div>
              </div>
              <div className="skill python">
                <div className="dial python" ref={pythonRef}></div>
              </div>
              <div className="skill webscraping">
                <div className="dial webscraping" ref={webscrapingRef}></div>
              </div>
